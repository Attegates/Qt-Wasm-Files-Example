...
// which compiling code that uses it also on non Q_OS_HTML5 platforms. We would
// ideally implement equivalent functionality using QFileDialog here, but that
// class is far away in the QtWidgets module.
